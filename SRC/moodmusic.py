...
def temperature_sensor():
    ...
    base_dir = '/sys/bus/w1/devices/' device_folder = glob.glob(base_dir
    + '28*')[0] device_folder2 = glob.glob(base_dir+'28*')[1]
    device_file = device_folder + '/w1_slave' device_file2 =
    device_folder2 + '/w1_slave' value1 = read_temp(device_file) value2
    = read_temp(device_file2) return value1, value2
    #combined setup from https://blog.oddbit.com/post/2018-03-27-multiple-1-wire-buses-on-the-/ AND 
